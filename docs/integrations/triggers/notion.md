...
5. In your Notion integration's settings, add that URL as a **Webhook subscription**. Notion sends a one-time **verification token** to the URL, which Valmis captures.
